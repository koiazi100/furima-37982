class PurchaseRecordsController < ApplicationController
  ...
  def purchase_params
    params.require(:purchase_record_shipping_address).permit(:postcode, :prefecture_id, :city, :block, :building, :phone_number).merge(user_id: current_user.id, item_id: params[:item_id],token: params[:token])
  end
